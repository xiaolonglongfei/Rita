...
export default function ModerationPage() {
  ...
  useEffect(() => {
    fetch("/api/moderation").then((r) => r.json()).then(setReviews).finally(() => setLoading(false));
  }, []);

  async function moderate(reviewId: number, status: "approved" | "rejected") {
