...
router.patch("/admin/moderation/:reviewId", requireAuth, async (req, res): Promise<void> => {
  ...
  res.json({
    ...
    technique: review.technique, communication: review.communication, patience: review.patience,
    adaptability: review.adaptability, expertise: review.expertise, overallScore: review.overallScore,
